...
class ExampleTestServiceProvider implements ServiceProviderInterface
{
    ...
    {
        // プラグイン用設定画面
        $app->match('/'.$app['config']['admin_route'].'/plugin/ExampleTest/config','Plugin\ExampleTest\Controller\ConfigController::index')->bind('plugin_ExampleTest_config');

        // 独自コントローラ
        $app->match('/plugin/ExampleTest/hello', 'Plugin\ExampleTest\Controller\ExampleTestController::index')->bind('plugin_ExampleTest_hello');
